...
type Identity struct {
	...
	// Identity method.
	//
	// Types that are valid to be assigned to MethodOneof:
	//
...
func (x *Identity) GetMethodOneof() isIdentity_MethodOneof {
	if x != nil {
		return x.MethodOneof
	}
	return nil
}
...
func (x *Identity) GetSoftwareHotpMethod() *SoftwareHOTPMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_SoftwareHotpMethod); ok {
...
func (x *Identity) GetSoftwareTotpMethod() *SoftwareTOTPMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_SoftwareTotpMethod); ok {
...
func (x *Identity) GetGoogleAuthHotpMethod() *GoogleAuthHOTPMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_GoogleAuthHotpMethod); ok {
...
func (x *Identity) GetGoogleAuthTotpMethod() *GoogleAuthTOTPMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_GoogleAuthTotpMethod); ok {
...
func (x *Identity) GetAppleIosTotpMethod() *AppleiOSTOTPMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_AppleIosTotpMethod); ok {
...
func (x *Identity) GetHardwareHotpMethod() *HardwareHOTPMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_HardwareHotpMethod); ok {
...
func (x *Identity) GetHardwareTotpMethod() *HardwareTOTPMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_HardwareTotpMethod); ok {
...
func (x *Identity) GetSmsMethod() *SMSMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_SmsMethod); ok {
			return x.SmsMethod
		}
	}
	return nil
...
func (x *Identity) GetPushoverMethod() *PushoverMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_PushoverMethod); ok {
...
func (x *Identity) GetEmailMethod() *EmailMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_EmailMethod); ok {
...
func (x *Identity) GetBackupCodesMethod() *BackupsCodesMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_BackupCodesMethod); ok {
...
func (x *Identity) GetSecurityQuestionsMethod() *SecurityQuestionsMethod {
	if x != nil {
		if x, ok := x.MethodOneof.(*Identity_SecurityQuestionsMethod); ok {
...
const file_api_ownmfa_app_identity_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/ownmfa_app_identity.proto\x12\n" +
	"ownmfa.api\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"\xf6\x03\n" +
	"\x03App\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x03R\x02id\x12\x1a\n" +
	"\x06org_id\x18\x02 \x01(\tB\x03\xe0A\x03R\x05orgID\x12\x1d\n" +
	"\x04name\x18\x03 \x01(\tB\t\xfaB\x06r\x04\x10\x05\x18(R\x04name\x12,\n" +
	"\fdisplay_name\x18\x04 \x01(\tB\t\xfaB\x06r\x04\x10\x05\x18PR\vdisplayName\x12 \n" +
	"\x05email\x18\x05 \x01(\tB\n" +
	"\xfaB\ar\x05\xd0\x01\x01`\x01R\x05email\x12*\n" +
	"\fpushover_key\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18-R\vpushoverKey\x123\n" +
	"\x10subject_template\x18\a \x01(\tB\b\xfaB\x05r\x03\x18\x80\bR\x0fsubjectTemplate\x126\n" +
	"\x12text_body_template\x18\b \x01(\tB\b\xfaB\x05r\x03\x18\x80 R\x10textBodyTemplate\x126\n" +
	"\x12html_body_template\x18\t \x01(\fB\b\xfaB\x05z\x03\x18\x80 R\x10htmlBodyTemplate\x12>\n" +
	"\n" +
	"created_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tcreatedAt\x12>\n" +
	"\n" +
	"updated_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tupdatedAt\"B\n" +
	"\x10CreateAppRequest\x12.\n" +
	"\x03app\x18\x01 \x01(\v2\x0f.ownmfa.api.AppB\v\xe0A\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x03app\",\n" +
	"\rGetAppRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x02id\"\x7f\n" +
	"\x10UpdateAppRequest\x12.\n" +
	"\x03app\x18\x01 \x01(\v2\x0f.ownmfa.api.AppB\v\xe0A\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x03app\x12;\n" +
	...
	"\x04apps\x18\x01 \x03(\v2\x0f.ownmfa.api.AppR\x04apps\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	"total_size\x18\x03 \x01(\x05R\ttotalSize\"\xa5\x01\n" +
	"\x12SoftwareHOTPMethod\x12$\n" +
	"\x04hash\x18\x01 \x01(\x0e2\x10.ownmfa.api.HashR\x04hash\x12#\n" +
	"\x06digits\x18\x02 \x01(\x05B\v\xfaB\b\x1a\x06\x18\n" +
	"(\x06@\x01R\x06digits\x12\x18\n" +
	"\acounter\x18\x03 \x01(\x05R\acounter\x12*\n" +
	"\faccount_name\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18PR\vaccountName\"\x8b\x01\n" +
	"\x12SoftwareTOTPMethod\x12$\n" +
	"\x04hash\x18\x01 \x01(\x0e2\x10.ownmfa.api.HashR\x04hash\x12#\n" +
	"\x06digits\x18\x02 \x01(\x05B\v\xfaB\b\x1a\x06\x18\n" +
	"(\x06@\x01R\x06digits\x12*\n" +
	"\faccount_name\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18PR\vaccountName\"B\n" +
	"\x14GoogleAuthHOTPMethod\x12*\n" +
	"\faccount_name\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x18PR\vaccountName\"B\n" +
	"\x14GoogleAuthTOTPMethod\x12*\n" +
	"\faccount_name\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x18PR\vaccountName\"\x14\n" +
	"\x12AppleiOSTOTPMethod\"\x98\x01\n" +
	"\x12HardwareHOTPMethod\x12$\n" +
	"\x04hash\x18\x01 \x01(\x0e2\x10.ownmfa.api.HashR\x04hash\x12!\n" +
	"\x06digits\x18\x02 \x01(\x05B\t\xfaB\x06\x1a\x04\x18\n" +
	"(\x06R\x06digits\x12\x18\n" +
	"\acounter\x18\x03 \x01(\x05R\acounter\x12\x1f\n" +
	"\x06secret\x18\x04 \x01(\fB\a\xfaB\x04z\x02\x10\x10R\x06secret\"~\n" +
	"\x12HardwareTOTPMethod\x12$\n" +
	"\x04hash\x18\x01 \x01(\x0e2\x10.ownmfa.api.HashR\x04hash\x12!\n" +
	"\x06digits\x18\x02 \x01(\x05B\t\xfaB\x06\x1a\x04\x18\n" +
	"(\x06R\x06digits\x12\x1f\n" +
	"\x06secret\x18\x03 \x01(\fB\a\xfaB\x04z\x02\x10\x10R\x06secret\",\n" +
	"\tSMSMethod\x12\x1f\n" +
	"\x05phone\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\b\x18\x10R\x05phone\">\n" +
	"\x0ePushoverMethod\x12,\n" +
	"\fpushover_key\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\x19\x18-R\vpushoverKey\",\n" +
	"\vEmailMethod\x12\x1d\n" +
	"\x05email\x18\x01 \x01(\tB\a\xfaB\x04r\x02`\x01R\x05email\"=\n" +
	"\x12BackupsCodesMethod\x12'\n" +
	"\tpasscodes\x18\x01 \x01(\x05B\t\xfaB\x06\x1a\x04\x18\n" +
	"(\x06R\tpasscodes\"<\n" +
	"\x17SecurityQuestionsMethod\x12!\n" +
	"\x06answer\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\x03\x18PR\x06answer\"\x9a\n" +
	"\n" +
	"\bIdentity\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x03R\x02id\x12\x1a\n" +
	"\x06org_id\x18\x02 \x01(\tB\x03\xe0A\x03R\x05orgID\x12\x1a\n" +
	"\x06app_id\x18\x03 \x01(\tB\x03\xe0A\x03R\x05appID\x12&\n" +
	"\acomment\x18\x04 \x01(\tB\f\xe0A\x02\xfaB\x06r\x04\x10\x05\x18PR\acomment\x127\n" +
	"\x06status\x18\x05 \x01(\x0e2\x1a.ownmfa.api.IdentityStatusB\x03\xe0A\x03R\x06status\x12R\n" +
	"\x14software_hotp_method\x18\x10 \x01(\v2\x1e.ownmfa.api.SoftwareHOTPMethodH\x00R\x12softwareHOTPMethod\x12R\n" +
	"\x14software_totp_method\x18\x06 \x01(\v2\x1e.ownmfa.api.SoftwareTOTPMethodH\x00R\x12softwareTOTPMethod\x12Y\n" +
	"\x17google_auth_hotp_method\x18\x11 \x01(\v2 .ownmfa.api.GoogleAuthHOTPMethodH\x00R\x14googleAuthHOTPMethod\x12Y\n" +
	"\x17google_auth_totp_method\x18\a \x01(\v2 .ownmfa.api.GoogleAuthTOTPMethodH\x00R\x14googleAuthTOTPMethod\x12S\n" +
	"\x15apple_ios_totp_method\x18\x16 \x01(\v2\x1e.ownmfa.api.AppleiOSTOTPMethodH\x00R\x12appleiOSTOTPMethod\x12R\n" +
	"\x14hardware_hotp_method\x18\x12 \x01(\v2\x1e.ownmfa.api.HardwareHOTPMethodH\x00R\x12hardwareHOTPMethod\x12R\n" +
	"\x14hardware_totp_method\x18\x13 \x01(\v2\x1e.ownmfa.api.HardwareTOTPMethodH\x00R\x12hardwareTOTPMethod\x126\n" +
	"\n" +
	"sms_method\x18\b \x01(\v2\x15.ownmfa.api.SMSMethodH\x00R\tsmsMethod\x12E\n" +
	"\x0fpushover_method\x18\x14 \x01(\v2\x1a.ownmfa.api.PushoverMethodH\x00R\x0epushoverMethod\x12<\n" +
	"\femail_method\x18\t \x01(\v2\x17.ownmfa.api.EmailMethodH\x00R\vemailMethod\x12P\n" +
	"\x13backup_codes_method\x18\n" +
	" \x01(\v2\x1e.ownmfa.api.BackupsCodesMethodH\x00R\x11backupCodesMethod\x12a\n" +
	"\x19security_questions_method\x18\x15 \x01(\v2#.ownmfa.api.SecurityQuestionsMethodH\x00R\x17securityQuestionsMethod\x12>\n" +
	"\n" +
	"created_at\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tcreatedAt\x12>\n" +
	"\n" +
	"updated_at\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tupdatedAtB\x13\n" +
	"\fmethod_oneof\x12\x03\xf8B\x01\"V\n" +
	"\x15CreateIdentityRequest\x12=\n" +
	"\bidentity\x18\x01 \x01(\v2\x14.ownmfa.api.IdentityB\v\xe0A\x02\xfaB\x05\x8a\x01\x02\x10\x01R\bidentity\"\x90\x01\n" +
	"\x16CreateIdentityResponse\x120\n" +
	"\bidentity\x18\x01 \x01(\v2\x14.ownmfa.api.IdentityR\bidentity\x12\x16\n" +
	"\x06secret\x18\x02 \x01(\tR\x06secret\x12\x0e\n" +
	"\x02qr\x18\x03 \x01(\fR\x02qr\x12\x1c\n" +
	"\tpasscodes\x18\x04 \x03(\tR\tpasscodes\"\x84\x01\n" +
	"\x17ActivateIdentityRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x02id\x12\"\n" +
	"\x06app_id\x18\x02 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x05appID\x12(\n" +
	"\bpasscode\x18\x03 \x01(\tB\f\xe0A\x02\xfaB\x06r\x04\x10\x03\x18PR\bpasscode\"[\n" +
	"\x18ChallengeIdentityRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x02id\x12\"\n" +
	"\x06app_id\x18\x02 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x05appID\"\x82\x01\n" +
	"\x15VerifyIdentityRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x02id\x12\"\n" +
	"\x06app_id\x18\x02 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x05appID\x12(\n" +
	"\bpasscode\x18\x03 \x01(\tB\f\xe0A\x02\xfaB\x06r\x04\x10\x03\x18PR\bpasscode\"U\n" +
	"\x12GetIdentityRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x02id\x12\"\n" +
	"\x06app_id\x18\x02 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x05appID\"X\n" +
	"\x15DeleteIdentityRequest\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x02id\x12\"\n" +
	"\x06app_id\x18\x02 \x01(\tB\v\xe0A\x02\xfaB\x05r\x03\xb0\x01\x01R\x05appID\"\x81\x01\n" +
	"\x15ListIdentitiesRequest\x12%\n" +
	"\tpage_size\x18\x01 \x01(\x05B\b\xfaB\x05\x1a\x03\x18\xfa\x01R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12\"\n" +
	"\x06app_id\x18\x03 \x01(\tB\v\xfaB\br\x06\xd0\x01\x01\xb0\x01\x01R\x05appID\"\x95\x01\n" +
	"\x16ListIdentitiesResponse\x124\n" +
	"\n" +
	"identities\x18\x01 \x03(\v2\x14.ownmfa.api.IdentityR\n" +
	"identities\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1d\n" +
	"\n" +
	...
	"\x04SHA1\x10\x022\x92\x0e\n" +
	"\x12AppIdentityService\x12\x92\x01\n" +
	"\tCreateApp\x12\x1c.ownmfa.api.CreateAppRequest\x1a\x0f.ownmfa.api.App\"V\x92A6J4\n" +
	"\x03201\x12-\n" +
	"\x16A successful response.\x12\x13\n" +
	"\x11\x1a\x0f.ownmfa.api.App\x82\xd3\xe4\x93\x02\x17:\x03app\"\x10/v1/applications\x12\xe5\x01\n" +
	"\x0eCreateIdentity\x12!.ownmfa.api.CreateIdentityRequest\x1a\".ownmfa.api.CreateIdentityResponse\"\x8b\x01\x92AIJG\n" +
	"\x03201\x12@\n" +
	"\x16A successful response.\x12&\n" +
	"$\x1a\".ownmfa.api.CreateIdentityResponse\x82\xd3\xe4\x93\x029:\bidentity\"-/v1/applications/{identity.app_id}/identities\x12\x8c\x01\n" +
	"\x10ActivateIdentity\x12#.ownmfa.api.ActivateIdentityRequest\x1a\x14.ownmfa.api.Identity\"=\x82\xd3\xe4\x93\x027:\x01*\x1a2/v1/applications/{app_id}/identities/{id}/activate\x12\xd8\x01\n" +
	"\x11ChallengeIdentity\x12$.ownmfa.api.ChallengeIdentityRequest\x1a\x16.google.protobuf.Empty\"\x84\x01\x92AFJ!\n" +
	"\x03202\x12\x1a\n" +
	"\x16A successful response.\x12\x00J!\n" +
	"\x03204\x12\x1a\n" +
	"\x16A successful response.\x12\x00\x82\xd3\xe4\x93\x025\"3/v1/applications/{app_id}/identities/{id}/challenge\x12\x88\x01\n" +
	"\x0eVerifyIdentity\x12!.ownmfa.api.VerifyIdentityRequest\x1a\x16.google.protobuf.Empty\";\x82\xd3\xe4\x93\x025:\x01*\"0/v1/applications/{app_id}/identities/{id}/verify\x12S\n" +
	...
	"\vGetIdentity\x12\x1e.ownmfa.api.GetIdentityRequest\x1a\x14.ownmfa.api.Identity\"1\x82\xd3\xe4\x93\x02+\x12)/v1/applications/{app_id}/identities/{id}\x12\x84\x01\n" +
	"\tUpdateApp\x12\x1c.ownmfa.api.UpdateAppRequest\x1a\x0f.ownmfa.api.App\"H\x82\xd3\xe4\x93\x02B:\x03appZ :\x03app2\x19/v1/applications/{app.id}\x1a\x19/v1/applications/{app.id}\x12\x86\x01\n" +
	"\tDeleteApp\x12\x1c.ownmfa.api.DeleteAppRequest\x1a\x16.google.protobuf.Empty\"C\x92A#J!\n" +
	"\x03204\x12\x1a\n" +
	"\x16A successful response.\x12\x00\x82\xd3\xe4\x93\x02\x17*\x15/v1/applications/{id}\x12\xa4\x01\n" +
	"\x0eDeleteIdentity\x12!.ownmfa.api.DeleteIdentityRequest\x1a\x16.google.protobuf.Empty\"W\x92A#J!\n" +
	"\x03204\x12\x1a\n" +
	"\x16A successful response.\x12\x00\x82\xd3\xe4\x93\x02+*)/v1/applications/{app_id}/identities/{id}\x12_\n" +
	"\bListApps\x12\x1b.ownmfa.api.ListAppsRequest\x1a\x1c.ownmfa.api.ListAppsResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/applications\x12\xa4\x01\n" +
	"\x0eListIdentities\x12!.ownmfa.api.ListIdentitiesRequest\x1a\".ownmfa.api.ListIdentitiesResponse\"K\x82\xd3\xe4\x93\x02EZ\x1d\x12\x1b/v1/applications/identities\x12$/v1/applications/{app_id}/identitiesB Z\x1egithub.com/ownmfa/proto/go/apib\x06proto3"

var (
	file_api_ownmfa_app_identity_proto_rawDescOnce sync.Once
	file_api_ownmfa_app_identity_proto_rawDescData []byte
)

func file_api_ownmfa_app_identity_proto_rawDescGZIP() []byte {
	file_api_ownmfa_app_identity_proto_rawDescOnce.Do(func() {
		file_api_ownmfa_app_identity_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_ownmfa_app_identity_proto_rawDesc), len(file_api_ownmfa_app_identity_proto_rawDesc)))
	})
...
var file_api_ownmfa_app_identity_proto_goTypes = []any{
...
func file_api_ownmfa_app_identity_proto_init() {
	...
	file_api_ownmfa_app_identity_proto_msgTypes[19].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_ownmfa_app_identity_proto_rawDesc), len(file_api_ownmfa_app_identity_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   29,
			NumExtensions: 0,
			NumServices:   1,
