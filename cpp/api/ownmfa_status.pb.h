...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_api_2fownmfa_5fstatus_2eproto;
}  // extern "C"
namespace ownmfa {
namespace api {
enum Status : int;
...
namespace protobuf {
template <>
internal::EnumTraitsT<::ownmfa::api::Status_internal_data_>
    internal::EnumTraitsImpl::value<::ownmfa::api::Status>;
}  // namespace protobuf
}  // namespace google
...
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::ownmfa::api::Status>() {
