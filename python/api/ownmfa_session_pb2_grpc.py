...
from api import ownmfa_session_pb2 as api_dot_ownmfa__session__pb2
...
def add_SessionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Login': grpc.unary_unary_rpc_method_handler(
                    servicer.Login,
                    request_deserializer=api_dot_ownmfa__session__pb2.LoginRequest.FromString,
                    response_serializer=api_dot_ownmfa__session__pb2.LoginResponse.SerializeToString,
            ),
            'CreateKey': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateKey,
                    request_deserializer=api_dot_ownmfa__session__pb2.CreateKeyRequest.FromString,
                    response_serializer=api_dot_ownmfa__session__pb2.CreateKeyResponse.SerializeToString,
            ),
            'DeleteKey': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteKey,
                    request_deserializer=api_dot_ownmfa__session__pb2.DeleteKeyRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'ListKeys': grpc.unary_unary_rpc_method_handler(
                    servicer.ListKeys,
                    request_deserializer=api_dot_ownmfa__session__pb2.ListKeysRequest.FromString,
                    response_serializer=api_dot_ownmfa__session__pb2.ListKeysResponse.SerializeToString,
            ),
    }
