...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='ownmfa.common',
  syntax='proto3',
  serialized_options=b'Z\037github.com/ownmfa/api/go/common',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x11\x63ommon/role.proto\x12\rownmfa.common*U\n\x04Role\x12\x14\n\x10ROLE_UNSPECIFIED\x10\x00\x12\n\n\x06VIEWER\x10\x04\x12\x11\n\rAUTHENTICATOR\x10\x08\x12\t\n\x05\x41\x44MIN\x10\x0c\x12\r\n\tSYS_ADMIN\x10\x0f\x42!Z\x1fgithub.com/ownmfa/api/go/commonb\x06proto3'
)

_ROLE = _descriptor.EnumDescriptor(
  name='Role',
  full_name='ownmfa.common.Role',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
