...
import 'ownmfa_role.pbenum.dart' as $4;
import 'ownmfa_status.pbenum.dart' as $5;
...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<$4.Role>(5, _omitFieldNames ? '' : 'role', enumValues: $4.Role.values)
    ..aE<$5.Status>(6, _omitFieldNames ? '' : 'status',
  ...
  /// User role.
  @$pb.TagNumber(5)
  $4.Role get role => $_getN(4);
  @$pb.TagNumber(5)
  set role($4.Role value) => $_setField(5, value);
  @$pb.TagNumber(5)
  ...
  /// User status.
  @$pb.TagNumber(6)
  $5.Status get status => $_getN(5);
  @$pb.TagNumber(6)
  set status($5.Status value) => $_setField(6, value);
  @$pb.TagNumber(6)
